...
func zslCreateNode(level int16, score int64, id int64) *skipListNode {
	n := &skipListNode{
		score: score,
		objID: id,
...
func (zsl *skipList) zslInsert(score int64, id int64) *skipListNode {
...
func (zsl *skipList) zslDelete(score int64, id int64) int {
	update := make([]*skipListNode, zSkiplistMaxlevel)
	x := zsl.header
	for i := zsl.level - 1; i >= 0; i-- {
		for x.level[i].forward != nil &&
 ...
 * first element. */
func (zsl *skipList) zslGetRank(score int64, key int64) int64 {
	rank := uint64(0)
	x := zsl.header
	for i := zsl.level - 1; i >= 0; i-- {
		for x.level[i].forward != nil &&
...
func (z *SortedSet) Set(score int64, key int64, dat interface{}) {
	v, ok := z.dict[key]
...
// IncrBy ..
func (z *SortedSet) IncrBy(score int64, key int64) (int64, interface{}) {
	v, ok := z.dict[key]
	if !ok {
...
func (z *SortedSet) GetRank(key int64, reverse bool) (rank int64, score int64, data interface{}) {
	v, ok := z.dict[key]
	if !ok {
		return -1, 0, nil
	}
...
func (z *SortedSet) GetDataByRank(rank int64, reverse bool) (key int64, score int64, data interface{}) {
...
func (z *SortedSet) Range(start, end int64, f func(int64, int64, interface{})) {
	z.commonRange(start, end, false, f)
}

// RevRange implements ZREVRANGE
func (z *SortedSet) RevRange(start, end int64, f func(int64, int64, interface{})) {
	z.commonRange(start, end, true, f)
}

func (z *SortedSet) commonRange(start, end int64, reverse bool, f func(int64, int64, interface{})) {
	l := z.zsl.length
	if start < 0 {
		start += l
		if start < 0 {
